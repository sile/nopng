...
impl IhdrChunk {
    pub(crate) const COLOR_TYPE_GRAYSCALE: u8 = 0;
    pub(crate) const COLOR_TYPE_RGB: u8 = 2;
    pub(crate) const COLOR_TYPE_INDEXED: u8 = 3;
    pub(crate) const COLOR_TYPE_GRAYSCALE_ALPHA: u8 = 4;
